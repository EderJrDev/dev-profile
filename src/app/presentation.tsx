  ...
  return (
    ...
    >
      ...
      <h1 className="text-black dark:text-white intro-text font-extrabold glow-title z-10 flex flex-col items-center">
        <span className="md:text-giant sm:text-[2rem] text-[3.5rem] md:text-[5rem] lg:text-[10rem] xl:text-[12rem] leading-none">
          Software
        </span>
        <span className="changing-text md:text-giant text-[3.5rem] md:text-[4rem] lg:text-[8rem] xl:text-[10rem]">
          Engineer
        </span>
      </h1>
    </section>
